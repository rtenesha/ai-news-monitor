...
- Открытие: придумай своё — короткая живая реакция или наблюдение. Не копируй примеры дословно.
  Варианты интонаций (выбери одну или придумай похожую):
  «Вот это поворот.» / «Давно этого ждала.» / «Интересный момент от [компания].» /
  «Пока все обсуждают X, тихо вышло Y.» / «Смотрю на это и думаю...» / «Честно, не ожидала.»
- НЕЛЬЗЯ начинать с «обратила внимание», «я нашла», «наткнулась на», «нашла интересную статью»
...
- Тон: тёплый и живой, первое лицо («я», «мне кажется», «для меня это...»)"""
