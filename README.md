...
**Решение:** скрипт парсит RSS-ленты, фильтрует по ключевым словам, затем Llama 3 оценивает каждую статью по релевантности 1–5 — утренний дайджест готов за 30 секунд.

**Репозиторий:** https://github.com/rtenesha/ai-news-monitor  
**Скилл `/digest`:** https://github.com/rtenesha/ai-news-monitor/blob/main/.claude/commands/digest.md
